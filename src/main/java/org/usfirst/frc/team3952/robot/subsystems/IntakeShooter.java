...
public class IntakeShooter extends SubsystemBase {
    ...
    public double getAngle() {
        //TODO haoyan doesn't know how to write code <-- fuck off
        return 0;
    }
    ...
    public Position getPosition() {
        ...
        for (Position p : Position.values()) {
            if (Math.abs(p.getDistance() - encoder) < Math.abs(toReturn.getDistance() - encoder)) // <--- what is this?? encoder isnt a factor
                toReturn = p;                                                                     // and if it is I dont see this working.
        }
        return toReturn;
    }
